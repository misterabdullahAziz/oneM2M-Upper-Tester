...
var rn_value, nu_value, nct_value, net_value;
...
if(testCaseID == "AE/GEN/00001")
{
	...
	adn2.createAE(origin,url,api,rr);
}
else if(testCaseID == "AE/REG/00002/00006"){
	//Create <AE> with pointOfAccess
	adn2.createAEpoa(AEOrigin,url,api,rr,poa);
}
else if(testCaseID == "AE/REG/00002/00006"){
	//Create <AE> with pointOfAccess
	adn2.createAEpoa(AEOrigin,url,api,rr,poa);
}
else if(testCaseID == "AE/SUB/00001/00001"){
	//Create <AE> with pointOfAccess
	adn2.createSubscription(origin,url,rn_value,nu_value,nct_value,net_value);
}